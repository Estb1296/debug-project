...
public class Concert {
    ...
    @NotBlank(message = "concert must have a title.")
    private String title;

    @NotBlank(message = "Concert must have a date")
    @FutureOrPresent(message = "The date of the concert must be in the future.")
